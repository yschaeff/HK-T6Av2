...
ch1_dr_off    = Data(OPC_PARAM_DUMP, UINT8,  3, range(128), None, "CH1 DR Off", "Output scaling when DR switch is off")
ch2_dr_off    = Data(OPC_PARAM_DUMP, UINT8,  5, range(128), None, "CH2 DR Off", "Output scaling when DR switch is off")
ch4_dr_off    = Data(OPC_PARAM_DUMP, UINT8,  7, range(128), None, "CH4 DR Off", "Output scaling when DR switch is off")
ch1_dr_on     = Data(OPC_PARAM_DUMP, UINT8,  4, range(128), None, "CH1 DR On", "Output scaling when DR switch is on")
ch2_dr_on     = Data(OPC_PARAM_DUMP, UINT8,  6, range(128), None, "CH2 DR On", "Output scaling when DR switch is on")
ch4_dr_on     = Data(OPC_PARAM_DUMP, UINT8,  8, range(128), None, "CH4 DR On", "Output scaling when DR switch is on")
...
thrcrv_norm_0 = Data(OPC_PARAM_DUMP, UINT8, 24, range(128), None, "Throttle Curve Normal P0", "Output characteristics of throttle stick")
thrcrv_norm_1 = Data(OPC_PARAM_DUMP, UINT8, 26, range(128), None, "Throttle Curve Normal P1", "Output characteristics of throttle stick")
thrcrv_norm_2 = Data(OPC_PARAM_DUMP, UINT8, 28, range(128), None, "Throttle Curve Normal P2", "Output characteristics of throttle stick")
thrcrv_norm_3 = Data(OPC_PARAM_DUMP, UINT8, 30, range(128), None, "Throttle Curve Normal P3", "Output characteristics of throttle stick")
thrcrv_norm_4 = Data(OPC_PARAM_DUMP, UINT8, 32, range(128), None, "Throttle Curve Normal P4", "Output characteristics of throttle stick")
thrcrv_idle_0 = Data(OPC_PARAM_DUMP, UINT8, 25, range(128), None, "Throttle Curve Idle P0", "Output characteristics of throttle stick when Idle-switch is in on position")
thrcrv_idle_1 = Data(OPC_PARAM_DUMP, UINT8, 27, range(128), None, "Throttle Curve Idle P1", "Output characteristics of throttle stick when Idle-switch is in on position")
thrcrv_idle_2 = Data(OPC_PARAM_DUMP, UINT8, 29, range(128), None, "Throttle Curve Idle P2", "Output characteristics of throttle stick when Idle-switch is in on position")
thrcrv_idle_3 = Data(OPC_PARAM_DUMP, UINT8, 31, range(128), None, "Throttle Curve Idle P3", "Output characteristics of throttle stick when Idle-switch is in on position")
thrcrv_idle_4 = Data(OPC_PARAM_DUMP, UINT8, 33, range(128), None, "Throttle Curve Idle P4", "Output characteristics of throttle stick when Idle-switch is in on position")

ptchcrv_norm_0 = Data(OPC_PARAM_DUMP, UINT8, 34, range(128), None, "Pitch Curve Normal P0", "Output characteristics of pitch stick")
ptchcrv_norm_1 = Data(OPC_PARAM_DUMP, UINT8, 36, range(128), None, "Pitch Curve Normal P1", "Output characteristics of pitch stick")
ptchcrv_norm_2 = Data(OPC_PARAM_DUMP, UINT8, 38, range(128), None, "Pitch Curve Normal P2", "Output characteristics of pitch stick")
ptchcrv_norm_3 = Data(OPC_PARAM_DUMP, UINT8, 40, range(128), None, "Pitch Curve Normal P3", "Output characteristics of pitch stick")
ptchcrv_norm_4 = Data(OPC_PARAM_DUMP, UINT8, 42, range(128), None, "Pitch Curve Normal P4", "Output characteristics of pitch stick")
ptchcrv_idle_0 = Data(OPC_PARAM_DUMP, UINT8, 35, range(128), None, "Pitch Curve Idle P0", "Output characteristics of pitch stick when Idle-switch is in on position")
ptchcrv_idle_1 = Data(OPC_PARAM_DUMP, UINT8, 37, range(128), None, "Pitch Curve Idle P1", "Output characteristics of pitch stick when Idle-switch is in on position")
ptchcrv_idle_2 = Data(OPC_PARAM_DUMP, UINT8, 39, range(128), None, "Pitch Curve Idle P2", "Output characteristics of pitch stick when Idle-switch is in on position")
ptchcrv_idle_3 = Data(OPC_PARAM_DUMP, UINT8, 41, range(128), None, "Pitch Curve Idle P3", "Output characteristics of pitch stick when Idle-switch is in on position")
ptchcrv_idle_4 = Data(OPC_PARAM_DUMP, UINT8, 43, range(128), None, "Pitch Curve Idle P4", "Output characteristics of pitch stick when Idle-switch is in on position")
